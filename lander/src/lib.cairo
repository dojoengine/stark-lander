...
impl ImplLander of ILander {
    ...
    fn new(position: Vec2) -> Lander{
        Lander {
            position: position,
            velocity: Vec2 { x: FixedTrait::new(1, false), y: FixedTrait::new(1, false) },
...
fn test_update() {
    ...
    let position = Vec2 { x: FixedTrait::new_unscaled(10, false), y: FixedTrait::new_unscaled(10000, false) };
